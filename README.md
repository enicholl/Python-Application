...
test/integration/default/default_test.rb file in the python cookbook repository)(All integration tests I used can be seen in the test/integration/default/default_test.rb file in the python cookbook
repository)
